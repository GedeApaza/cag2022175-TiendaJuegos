        ...
        <aside id="sidebar" class="js-sidebar">
            ...
            <div class="h-100">
                <div class="sidebar-logo">
                    <a href="{{ route('dashboard') }}">{{ Auth::guard('cliente')->user()->nombres }}
                        {{ Auth::guard('cliente')->user()->apellidos }} </a>
                </div>
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a href="{{ route('cliente_dashboard') }}" class="sidebar-link">
                        ...
                        <ul id="pages" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            <li class="sidebar-item">
                                <a href="" class="sidebar-link"><i
                                        class="fas fa-map-marked-alt"></i> Listar Compras</a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-item">
                        ...
                        <ul id="posts" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            <li class="sidebar-item">
                                <a href="" class="sidebar-link">
                                    <i class="fas fa-chart-line pe-2"></i> Listar Facturas
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <a href="#" data-bs-toggle="dropdown" class="nav-icon pe-md-0">
                                @if (Auth::guard('cliente')->user()->foto_perfil)
                                <img src="{{ asset('fotos/' . basename(Auth::guard('cliente')->user()->foto_perfil)) }}"
                                    class="avatar img-fluid rounded" alt="">
                                @else
                                <div class="avatar img-fluid rounded no-avatar">
                                    {{ strtoupper(substr(Auth::guard('cliente')->user()->nombres, 0, 1)) }}
                                    {{ strtoupper(substr(Auth::guard('cliente')->user()->apellidos, 0, 1)) }}
                                </div>
                                @endif
                            </a>
                            <!-- Menú desplegable -->
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <form id="logout-form" action="{{ route('cliente.logout') }}" method="GET" class="d-none">
                                    @csrf
                                </form>
                            </div>
                        </li>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="img-container">
                                            <img id="foto_perfil_actual"
                                                src="{{ asset('fotos/' . basename(Auth::guard('cliente')->user()->foto_perfil)) }}"
                                        ...
                                        <div class="col-6">
                                            <div class="p-3 m-1">
                                                ...
                                                <p class="mb-0">
                                                    ...
                                                    {{ Auth::guard('cliente')->user()->apellidos }}
                                                </p>
                                            </div>
                                        </div>
